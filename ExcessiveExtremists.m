% model parameters
N           = 21;   % the number of agents
N_LEFT      = 3;    % the number of left extremists (default: 1)
...
memory_length       = 200;  % how long should we remember things
...
plotter.SaveDirectlyToTex('images/excessive.extremists.tex', points);
