...
N_LEFT      = 4;    % the number of left extremists (default: 1)
N_RIGHT     = 4;	% the number of right extremists (default: 1)
epsilon     = 0.1;
eps_left    = 2 * epsilon;	% the probability of left extremists to become even more radical
...
plotter.Save('images/stubborn.left.extremists.tex');
